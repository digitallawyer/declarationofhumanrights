...
class SupportersControllerTest < ActionController::TestCase
  ...
  test "should create supporter" do
    assert_difference('Supporter.count') do
      post :create, supporter: { comment: @supporter.comment, country: @supporter.country, email: @supporter.email, name: @supporter.name, signing_date: @supporter.signing_date }
    end
  ...
  test "should update supporter" do
    patch :update, id: @supporter, supporter: { comment: @supporter.comment, country: @supporter.country, email: @supporter.email, name: @supporter.name, signing_date: @supporter.signing_date }
    assert_redirected_to supporter_path(assigns(:supporter))
  end
